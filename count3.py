...
def run(weights='models/best.pt', source=None, device='cpu', view_img=False, save_img=False, exist_ok=False, classes=None, line_thickness=2, track_thickness=2, region_thickness=2):
    ...
    if not Path(weights).exists():
        raise FileNotFoundError(f"Weights file '{weights}' does not exist.")
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default='models/best.pt', help='initial weights (model file) path')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or cpu')
    parser.add_argument('--source', type=str, default='/home/coatcn/workspace/yolocode/video/VID_20240223_152846.mp4', help='video file path')
