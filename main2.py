...
# auto_annotate(data='数据集地址',det_model='yolov8.pt',sam_model='sam.pt')
...
if __name__ == '__main__':
    ...
    model.train(**{'cfg': 'ultralytics/cfg/default1.yaml', 'data': 'ultralytics/cfg/datasets/Mydata_seg_instance_mushroom.yaml'},
                epochs=500, imgsz=640, batch=64, name='train')  # name：是此次训练结果保存的文件夹   数据集是我自己的数据集
